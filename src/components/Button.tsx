  ...
  ({ className, variant = 'primary', size = 'md', ...props }, ref) => {
    ...
    return (
      <button
        ref={ref}
        className={cn(
          "inline-flex items-center justify-center rounded-xl font-medium transition-all duration-300 active:scale-[0.97] active:opacity-90 active:shadow-inner disabled:opacity-40 disabled:pointer-events-none disabled:scale-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 hover:shadow-md hover:shadow-primary/30",
          variants[variant],
          sizes[size],
          className
        )}
